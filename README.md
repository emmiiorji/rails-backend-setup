...
A project to demonstrate setting up a Ruby on Rails project as a backend only app.
...
- Clone this repository to your desired folder:
    ```sh
    cd my-folder
    git clone git@github.com:emmiiorji/hello-react-rails.git
    ```
